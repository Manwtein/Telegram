...
public class ReactionsSpanImage extends ImageSpan {
...
//    private ContactsController.Contact currentContact;
    ...
    public ReactionsSpanImage(Emoji.EmojiDrawable d, int verticalAlignment, int s, Paint.FontMetricsInt original, TLRPC.TL_reactionCount reactionCount/*, TLRPC.Document document*/) {
//        super(context);
...
//            invalidate();
        ...
        canvas.save();
        rect.set(0, 0, getDrawable().getIntrinsicWidth(), AndroidUtilities.dp(32));
...
//            deleteDrawable.draw(canvas);
        ...
        int text2 = Theme.getColor(Theme.key_groupcreate_spanText);
        int textSelected = Theme.getColor(Theme.key_avatar_text);
        textPaint.setColor(ColorUtils.blendARGB(text2, textSelected, progress));
